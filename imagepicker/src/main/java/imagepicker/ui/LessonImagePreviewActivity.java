 ...
 * ================================================
 */
public class LessonImagePreviewActivity extends ImagePreviewBaseActivity implements View.OnClickListener {
...
//            public void onClick(DialogInterface dialog, int which) {
                //移除当前图片刷新界面
    	ImagePicker.getInstance().clearItemImage(mImageItems.get(mCurrentPosition));
