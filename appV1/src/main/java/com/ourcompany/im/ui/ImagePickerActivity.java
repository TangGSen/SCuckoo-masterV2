...
import com.ourcompany.im.BaseActivity;
import com.ourcompany.im.model.RecyclingImageView;
import com.ourcompany.im.model.VideoEntity;
import com.ourcompany.im.utils.ImageCache;
import com.ourcompany.im.utils.ImageResizer;
import com.ourcompany.im.utils.LoadImageUtils;
...
public class ImagePickerActivity extends BaseActivity {
	...
	protected void onCreate(@Nullable Bundle savedInstanceState) {
		...
		imageResizer.setLoadingImage(R.mipmap.empty_photo);
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(final int position,View convertView,ViewGroup container) {
			...
			if (convertView == null) {
				...
				convertView = LayoutInflater.from(context).inflate(R.layout.layout_choose_griditem, container, false);
			...
			if (isShowPhote) {
				LoadImageUtils.loadImageView(getApplicationContext(), holder.imageView, entty.filePath, R.mipmap.empty_photo);
			} else {
