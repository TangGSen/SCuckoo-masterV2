...
public class MFooter extends InternalClassics<MFooter> implements RefreshFooter {
    ...
    public MFooter(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        lpProgress.width = (int) (ta.getLayoutDimension(R.styleable.ClassicsFooter_srlDrawableSize, lpProgress.width)*0.8);
        lpProgress.height = (int) (ta.getLayoutDimension(R.styleable.ClassicsFooter_srlDrawableSize, lpProgress.height)*0.8);
